...
const GetSelect = async () => {
  ...
  try {
    const res = await API.get("merchantselect", {
      headers: token,
    });
    return res.data;
  } catch (err) {
...
const Add = async (input) => {
  let token = await GetHeader();
  try {
    const res = await API.post("merchant", input, {
      headers: token,
    });
    return res.data;
  } catch (err) {
...
const Delete = async (input) => {
  let token = await GetHeader();
  try {
    const res = await API.delete(`merchant/${input}`, {
      headers: token,
    });
    return res.data;
  } catch (err) {
...
const Update = async (input) => {
  let token = await GetHeader();
  try {
    const res = await API.put("merchant", input, {
      headers: token,
    });
    return res.data;
  } catch (err) {
