...
const Get = async () => {
  ...
  try {
    const res = await API.get("merchantpartner", {
      headers: token,
    });
    return res.data;
  } catch (err) {
...
const Add = async (input) => {
  let token = await GetHeader();
  try {
    const res = await API.post("merchantpartner", input, {
      headers: token,
    });
    return res.data;
  } catch (err) {
...
const Delete = async (input) => {
  let token = await GetHeader();
  try {
    const res = await API.delete(`merchantpartner/${input}`, {
      headers: token,
    });
    return res.data;
  } catch (err) {
...
const Update = async (input) => {
  let token = await GetHeader();
  try {
    const res = await API.put("merchantpartner", input, {
      headers: token,
    });
    return res.data;
  } catch (err) {
